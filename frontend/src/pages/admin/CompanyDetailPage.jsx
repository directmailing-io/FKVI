  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
        <p className="text-xs font-medium text-amber-800 mb-1">Für Notizen-Funktion SQL ausführen:</p>
        <code className="text-xs text-amber-700 font-mono">
          ALTER TABLE public.companies ADD COLUMN IF NOT EXISTS notes_list JSONB DEFAULT '[]'::jsonb;
        </code>
      </div>
