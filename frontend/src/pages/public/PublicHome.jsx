        ...
        <div className="text-center mb-12">
          ...
          <p className="text-white/60 max-w-xl mx-auto">
            {mode === 'az'
              ...
              : <>6 Stufen bis zur perfekten Passung. Jede Stufe filtert gezielt, damit nur Fachkräfte vermittelt werden, die <strong className="text-white font-bold">wirklich passen</strong> und langfristig bleiben.</>
            }
          </p>
        </div>
