...
export default function ImpressumPage() {
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <title>Impressum | FKVI – Fachkraft Vermittlung International</title>
        <meta name="description" content="Impressum der Fachkraft Vermittlung International GmbH & Co. KG, Ammelburgstraße 34, 60320 Frankfurt am Main." />
        <link rel="canonical" href="https://fkvi-plattform.de/impressum" />
