...
import { CheckCircle2, ClipboardCopy, Check, FileText, Loader2, Link2, Mail, AlertCircle } from 'lucide-react'
 ...
 */
export default function SendDocumentDialog({ entityType = 'profile', entityId, prefillData = {}, defaultSignerName = '', defaultEmail = '', session, onClose, onSent }) {
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg bg-green-50 border border-green-200 p-4 space-y-3">
              ...
              <p className="text-xs text-gray-500">
                Teile diesen Link per E-Mail, WhatsApp oder direkt:
              </p>
